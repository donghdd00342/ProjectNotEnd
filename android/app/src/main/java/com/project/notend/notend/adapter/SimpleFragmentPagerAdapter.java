...
public class SimpleFragmentPagerAdapter extends FragmentPagerAdapter {
    ...
    private String tabTitles[] = new String[] { "List", "human","Messenger","YourSelf" };
    private int[] imageResId = { R.drawable.human, R.drawable.administrator ,R.drawable.communication,R.drawable.administrator};
